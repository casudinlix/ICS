...
<link rel="shortcut icon" href="<?php echo gambarlink()?>"/>
<link rel="icon" href="<?php echo gambarlink()?>favicon.ico" type="image/x-icon" />
        <!-- text fonts -->


        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo tema()?>css/ace.min.css" />
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo site_url('welcome/cek')?>" method="post">
                                                <fieldset>
...
<![endif]-->
    ...
    <script type="text/javascript">
         alertify.error('Access Not Allowed!!');
    </script>
<?php endif; ?>
<?php if ($this->session->flashdata('gagal')): ?>
    <script type="text/javascript">
         alertify.error('your name or password is wrong!!');
    </script>
<?php endif; ?>
    </body>
</html>
