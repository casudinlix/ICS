...
<input type="hidden" value="<?php echo base64_decode($this->uri->segment(4))?>" name="id" />
      <div class="col-sm-9">
        <input type="text" value="<?php echo $q->user_nip?>" autocomplete="off" maxlength="6" placeholder="NIP" name="nip" required="true" class="col-xs-10 col-sm-5" onkeypress="return angka(event)" />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" value="<?php echo $q->username ?>" placeholder="User Name" name="username" class="col-xs-10 col-sm-5" autocomplete="off" />
      </div>
    </div>
...
<select id="user"  class="col-xs-10 col-sm-5" name="group" required="">
  <option value="<?php echo $q->id?>"><?php echo $q->id." ".$group->group_name ?></option>
<option value=""></option>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <span class="input-icon">
          <input type="password" id="form-field-icon-1" name="pass" value="<?php echo base64_decode($q->pass) ?>" />
