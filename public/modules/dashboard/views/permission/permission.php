...
<div class="page-header">
							<h1>
								...
								<?php if ($add==TRUE): ?>
								<a href="<?php echo site_url('dashboard/utility/menu/add')?>">	<button class="btn btn-white btn-info btn-bold" data-rel="tooltip" data-placement="right" title="New Permission">
...
<button class="btn btn-white btn-danger btn-bold" onclick="hapusmenup('<?php echo base64_encode($key->id)?>')" class=" tooltip-warning" data-rel="tooltip" data-placement="right" title="Delete"><i class="ace-icon fa fa-trash align-top bigger-125 blue"></i></button>
