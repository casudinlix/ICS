...
(function($) {
  function lookupbox(options) {
    var settings = {
      ...
      width: 400,
      htmlForm: '<form id="lookupbox-search-form" onsubmit="return false"><input autocomplete="off" id="lookupbox-search-key" type="text" name="key" placeholder="Enter search criteria." /> <input type="button" id="lookupbox-search-button" value="Search" /> <span id="loading"></span></form><div id="lookupbox-search-result"></div>',
      modal: true,
      draggable: true,
      onItemSelected: null,
      item: null,
